...
import net.isger.brick.util.hitcher.scan.FileScan;
import net.isger.brick.util.hitcher.scan.JarScan;
...
public class Scanner extends Director {
    ...
    private static final String KEY_SCANS = "brick.util.hitcher.scans";

    private static final String SCAN_PATH = "net/isger/brick/util/hitcher/scan";
    ...
    public void add(Scan scan) {
        LOG.info("Binded the scan with {}", scan);
        scans.add(scan);
    }
